...
| D4 | technical-stop-requirements.md | Add note: "Requirements document from v1 era. Current implementation is in robson-engine/src/technical_stop_analyzer.rs (Rust). Python/pandas references are historical." | ✅ Applied 2026-04-18 |
