...
- `migrations/20240101000008_create_monthly_state.sql` — current schema
- `migrations/20240101000010_add_realized_loss_trades_opened.sql` — new (created)
- `robsond/src/position_manager.rs:178-204` — load_capital_base_for_month
- `robsond/src/position_manager.rs:622-737` — build_risk_context
- `robsond/src/position_manager.rs:1439-1520` — evaluate_monthly_halt
- `robsond/src/daemon.rs:460-518` — startup sequence (rebuild_store, restore_positions)
- `robson-projector/src/apply.rs` — projection routing
- `robson-projector/src/handlers/monthly_state.rs` — current MonthBoundaryReset handler
- `robson-projector/src/handlers/positions.rs:649-687` — handle_entry_filled
- `robson-projector/src/handlers/positions.rs:1087-1128` — handle_position_closed_domain
- `robson-projector/src/types.rs` — projection payload types (EntryFilled, PositionClosedDomain)
- `robson-domain/src/events.rs` — domain event definitions
...
- **Files changed**: `migrations/20240101000010_add_realized_loss_trades_opened.sql` (new)
...
- **Files changed**: `robson-projector/src/handlers/monthly_state.rs`, `robson-projector/src/apply.rs`
...
- **Files changed**: `robsond/src/position_manager.rs`
...
- **Files changed**: `robson-projector/src/handlers/monthly_state.rs`
- **Verification**: `rtk cargo check -p robson-projector`
...
- **Files changed**: `migrations/20240101000011_backfill_current_month_state.sql` (new)
...
- **Files changed**: `robsond/src/position_manager.rs` (test module)
