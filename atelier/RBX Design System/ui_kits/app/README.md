...
Interactive recreation of the Robson operations dashboard. Open `index.html` for a click-thru prototype: dashboard → trading intent → command dock.

## Components
- `AppShell.jsx` — header + main layout
