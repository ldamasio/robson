      ...
      <Stack gap={5}>
        ...
        <div class="current-state">
          ...
          <div class="state-line">
            ...
            ACTIVE · {$_('killSwitch.slotLabel')} {activeCount}/{status?.slot_cells_total ?? activeCount} · {activeCount} {activeCount === 1 ? ($_('killSwitch.openPositions_one') ?? 'OPEN POSITION') : ($_('killSwitch.openPositions_other') ?? 'OPEN POSITIONS')}
          </div>
        </div>
