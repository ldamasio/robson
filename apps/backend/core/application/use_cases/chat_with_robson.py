...
- Once complete, offer to save to Thesis Journal
...
- DO ask if thesis is observational or for trading
...
"""
    ...
    def _detect_intent(
        ...
        # Thesis intent - user wants to structure a market hypothesis
        if any(
            word in user_lower
            for word in [
                "tese", "thesis", "hipotese", "hypothesis",
                "estruturar como tese", "structure as thesis",
                "diario", "journal", "observacao", "observation",
                "acho que vai", "i think", "está com cara de", "looks like",
                "talvez", "maybe", "provavelmente", "probably",
            ]
        ):
            return IntentType.THESIS
