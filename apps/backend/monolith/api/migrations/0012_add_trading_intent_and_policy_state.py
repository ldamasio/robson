# Generated manually based on TradingIntent and PolicyState models
# Created: 2025-12-24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['client', 'status', 'created_at'], name='api_trading_client__idx'),
        ),
        migrations.AddIndex(
            model_name='tradingintent',
            index=models.Index(fields=['symbol', 'created_at'], name='api_trading_symbol__idx'),
        ),
        migrations.AddIndex(
            model_name='tradingintent',
            index=models.Index(fields=['strategy', 'created_at'], name='api_trading_strateg_idx'),
        ),
        migrations.AddIndex(
            model_name='policystate',
            index=models.Index(fields=['client', 'month'], name='api_policys_client__idx'),
        ),
        migrations.AddIndex(
            model_name='policystate',
            index=models.Index(fields=['status', 'month'], name='api_policys_status_idx'),
        ),
