...
describe('deriveSlots', () => {
  ...
  it('marks first N slots occupied for N active positions', () => {
    const positions = [
      ...
      { id: 'b', state: { Active: { current_price: 100, trailing_stop: 95, favorable_extreme: 110, extreme_at: '', insurance_stop_id: null, last_emitted_stop: null } } as PositionState }
    ];
  ...
  it('exits Closed/Error positions are not active', () => {
    const positions = [
...
describe('occupiedCount', () => {
  it('counts Armed + Entering + Active only', () => {
    const positions = [
      ...
      { state: { Active: { current_price: 100, trailing_stop: 95, favorable_extreme: 110, extreme_at: '', insurance_stop_id: null, last_emitted_stop: null } } as PositionState },
